...
# Set binning of measured MC (after detector sim) in variable y
...
# Plot the columns Aj of A containing the histograms of mc_meas when f(x)=pj(x). The sum should be the distribution mc_meas.
...
plt.plot(x, norm_truth * pdf, "k-", label="true pdf (renormed)")
plt.hist(true, bins=bins_meas, normed=False, label="mc_truth", histtype='stepfilled', alpha=.2)
